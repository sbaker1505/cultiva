const catalog = {
    ...
    microgreens: [
      {
        ...
        description: {
          ...
          look: {   en: 'english text here',
          es: 'Hojas de dos tipos lanceoladas y aserrads de color verde, tallos delgados y verdes.'},
        }
      },
    ],
  },
    ...
    flowers: [
      {
        ...
        description: {
          ...
          look: {   en: 'english text here',
          es: 'Flores medianas de color amarillo y tallo verde.'},
        }
      },
    ],
  },
  vegetables: {
    title: {
      en: 'Extraordinary Vegetales',
      es: 'Vegetales Extraordinarios'
    },
    vegetables: [
      {
        name: {     en: 'English name (Veggy)',
                    es: 'Veggy'},
        id:             '0001',
        image: [        '#.jpg'],
        keywords: [     'vegetables'],
